...
//    }, 500);
    ...
    $('.close-share-bottom, #content, #content1, .open-menu').click(function(){
	...
	var owldbsectionControls = $(".dbsection-slider");
	owldbsectionControls.owlCarousel({
		//Basic Stuff
		items : 3,
		itemsDesktop : [1199,3],
	...
	$(".next-dbsection").click(function(){
	  owldbsectionControls.trigger('owl.next');
	  return false;
	});
	$(".prev-dbsection").click(function(){
	  owldbsectionControls.trigger('owl.prev');
	  return false;
	});
